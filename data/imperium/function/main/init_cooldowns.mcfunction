...
function imperium:abilities/set_cd {kit:"Cliffshield",slot:"B",base:0,stock:-1}
function imperium:abilities/set_cd {kit:"Cliffshield",slot:"C",base:0,stock:-1}

# Levent: A Levitation Arrows, B Shield, C Reversal
function imperium:abilities/set_cd {kit:"Levent",slot:"A",base:0,stock:-1}
function imperium:abilities/set_cd {kit:"Levent",slot:"B",base:0,stock:-1}
function imperium:abilities/set_cd {kit:"Levent",slot:"C",base:0,stock:-1}

# Livvy: A Leap, B Web, C Acid Potion
function imperium:abilities/set_cd {kit:"Livvy",slot:"A",base:0,stock:-1}
function imperium:abilities/set_cd {kit:"Livvy",slot:"B",base:0,stock:-1}
function imperium:abilities/set_cd {kit:"Livvy",slot:"C",base:0,stock:-1}
#   Damage Score (1/10 HP) needed for 1 soup
scoreboard players set #lsThreshold im_lifesteal 100

# Meowdy: A Leap, B Arrows  (C empty)
function imperium:abilities/set_cd {kit:"Meowdy",slot:"A",base:0,stock:-1}
function imperium:abilities/set_cd {kit:"Meowdy",slot:"B",base:120,stock:90}

# Mummy: A Golem Throw (200), B Grapple Rod  (C empty)
function imperium:abilities/set_cd {kit:"Mummy",slot:"A",base:200,stock:-1}
function imperium:abilities/set_cd {kit:"Mummy",slot:"B",base:0,stock:-1}

# Rastus: A Buckler Shield, B Parry (100)  (C empty)
function imperium:abilities/set_cd {kit:"Rastus",slot:"A",base:0,stock:-1}
function imperium:abilities/set_cd {kit:"Rastus",slot:"B",base:100,stock:-1}

# Smokey: A Boost Rod, B Marking Dart, C Smoke Bomb
function imperium:abilities/set_cd {kit:"Smokey",slot:"A",base:0,stock:-1}
function imperium:abilities/set_cd {kit:"Smokey",slot:"B",base:0,stock:-1}
function imperium:abilities/set_cd {kit:"Smokey",slot:"C",base:0,stock:-1}
