...
execute at @s anchored eyes run summon interaction ^ ^-0.001 ^3 {width:1f,height:1f,Tags:["im.aim","im.aim_new","summit.booth_entity.imperium"]}
...
execute if score #Debug im_debug_mode matches 1 run say aim_bind