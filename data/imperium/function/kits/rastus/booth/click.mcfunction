...
advancement revoke @s only imperium:booth/select_rastus
execute if predicate imperium:sneaking run function imperium:kits/rastus/booth/lore
execute unless predicate imperium:sneaking run function imperium:kits/rastus/booth/select
