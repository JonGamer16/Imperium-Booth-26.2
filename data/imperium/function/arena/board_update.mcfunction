...
execute unless entity @e[tag=im.gold_board_text] run return 0

tag @a remove im.rank1
tag @a remove im.rank2
tag @a remove im.rank3
...
data modify entity @e[tag=im.gold_board_text,limit=1] text set value [{text:"⚔ Gold Rush ⚔\n",color:"gold",bold:true},{text:"1st - ",color:"yellow"},{selector:"@a[tag=im.rank1,limit=1]",color:"yellow"},{text:" [",color:"yellow"},{score:{name:"@a[tag=im.rank1,limit=1]",objective:"im_gold"},color:"yellow"},{text:" Gold]\n",color:"yellow"},{text:"2nd - ",color:"gray"},{selector:"@a[tag=im.rank2,limit=1]",color:"gray"},{text:" [",color:"gray"},{score:{name:"@a[tag=im.rank2,limit=1]",objective:"im_gold"},color:"gray"},{text:" Gold]\n",color:"gray"},{text:"3rd - ",color:"gold"},{selector:"@a[tag=im.rank3,limit=1]",color:"gold"},{text:" [",color:"gold"},{score:{name:"@a[tag=im.rank3,limit=1]",objective:"im_gold"},color:"gold"},{text:" Gold]",color:"gold"}]
