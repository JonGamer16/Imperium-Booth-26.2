...
tellraw @a [{"selector":"@a[tag=im.feed_victim,limit=1]","color":"yellow"},{"text":" lost ","color":"yellow"},{"score":{"name":"#lost","objective":"im.temp"},"color":"gold"},{"text":" Gold","color":"yellow"}]
